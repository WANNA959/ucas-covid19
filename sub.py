...
def submit(s: requests.Session, old: dict):
    new_daily = {
        ...
        'sfcyglq': old['sfcyglq'],  # 是否处于隔离期（观察期
        ...
        # 'remark': old['remark'],
        'jcjgqk': old['jcjgqk'],  #情况
        # 'jcwhryfs': old['jcwhryfs'],# 2021.8.1 del
        # 'jchbryfs': old['jchbryfs'],# 2021.8.1 del
        'gtshcyjkzt': old['gtshcyjkzt'],  # add @2020.9.16 共同生活人员健康状况
        'jrsfdgzgfxdq': old['jrsfdgzgfxdq'],  # add @2020.9.16 近日是否到过中高风险地区
        'jrsflj': old['jrsflj'],  # add @2020.9.16 近日是否离京
        'app_id': 'ucas'
    }
...
def send_email(sender, mail_passwd, receiver, subject, msg):
    ...
    try:
        ...
        body['From'] = formataddr(["UCAS疫情填报助手", sender])
